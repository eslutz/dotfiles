...
__USER_CANCELED=0
trap 'echo; error "Template processing canceled by user."; __USER_CANCELED=1; exit 130' INT TERM
trap '[ "$__USER_CANCELED" -eq 0 ] && echo "Template processing complete."' EXIT
